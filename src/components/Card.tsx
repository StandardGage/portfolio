...
export default function Card(props:any) {
    ...
    return(
        <motion.div initial="rest" animate={{scale:[0,1]}} style={{transformStyle: "preserve-3d"}} whileHover="hover" className={`min-w-[314px] min-h-[314px] relative flex justify-center`}>
            <motion.div
            variants={front}
